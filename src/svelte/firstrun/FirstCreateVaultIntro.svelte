<script>    
    ...
    //Context
    const { back, nextPage } = getContext('functions');
...
<LeftSideFullPage title={'Secret Recovery Phrase'} helpLink="/wallet/first_vault_install">
    ...
    <div class="text-primary flex flex-just-center" slot="content">
        <div class="flex-column">
            ...
            <div class="text-body1 comment">Vault accounts make it easier to backup and restore your accounts with our new Secret Recovery phrase. For vault accounts, your Secret Recovery phrase will save all your current and future accounts.</div>
            <div class="flex-column flow-buttons">
                <Button id="create-wallet"
                        classes={'button__solid button__primary'}
                        margin={'0 0 1.25rem 0'}
                        name="VIEW SECRET RECOVERY PHRASE" 
                        width={'347px'}
                        click={() => nextPage()} />
