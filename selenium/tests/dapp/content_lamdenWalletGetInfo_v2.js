...
describe('Content Script - Testing Dapp GetInfo API', function () {
    ...
    it('Returns wallet info', async function() {
        ...
        assert.equal(response.approvals[`${dappsInfo.basicConnectionInfo.networkName}`][`${dappsInfo.basicConnectionInfo.networkType}`].contractName, dappsInfo.basicConnectionInfo.contractName)
    });
